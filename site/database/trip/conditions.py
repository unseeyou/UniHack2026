...
class RoadCondition(db.Model):
    ...
    analysis: Mapped["Analysis | None"] = relationship(back_populates="road_conditions", lazy="joined")
...
class WeatherCondition(db.Model):
    ...
    analysis_id: Mapped[int] = mapped_column(ForeignKey("analysis.id"))
    analysis: Mapped["Analysis | None"] = relationship(back_populates="weather_conditions", lazy="joined")
